                ...
                <a href='/#' className='service-action'>
                  ...
                  <div className='service-content'>
                    ...
                    <p className='service-subtitle'>
                      All purchases over $199 are eligible forfree shipping via USPS First className
                      Mail.
                    </p>
                  </div>
                </a>
              ...
              <div className='service'>
                <a href='/#' className='service-action'>
                  ...
                  <div className='service-content'>
                    ...
                    <p className='service-subtitle'>
                      If an item arrived damaged or you'vechanged your mind, you can send itback for
                      a full refund.
                    </p>
                  </div>
                </a>
