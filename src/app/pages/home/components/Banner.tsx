              ...
              <ul className='statistic-list d-flex'>
                <li className='statistic-item'>
                  <div className='statistic d-flex'>
                    ...
                    <div className='statistic-content'>
                      ...
                      <p className='statistic-description'>On purchases over $199</p>
                    </div>
                  </div>
                </li>
                ...
                <li className='statistic-item'>
                  <div className='statistic d-flex'>
                    ...
                    <div className='statistic-content'>
                      <h4 className='statistic-title'>99% Satisfied Customers</h4>
                ...
                <li className='statistic-item'>
                  <div className='statistic d-flex'>
                    ...
                    <div className='statistic-content'>
                      <h4 className='statistic-title'>Originality Guaranteed</h4>
                      <p className='statistic-description'>
